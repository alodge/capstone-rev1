...
$(document).ready(function() {
  ...
  BurgerContract = eth
  	.contract(abi)
  	.at("0x5c87e1c456dcedfab139df81a7ca331bb0c14dda");
...
async function transferCoin(){
  ...
  var tranString = {}
  tranString.gas = 70000;
  tranString.from = fromAddress;
  var tranObject = JSON.stringify(tranString);
  console.log(tranString);
  console.log(tranObject);
  
  // also callback 
  // t_contract.transfer.call(toAddress, sendAmount, { from: fromAddress });
...
function moveCoin(fromAddress, toAddress, qty) {
  return new Promise(function(resolve, reject) {
    BurgerContract.transfer.call(toAddress, qty, function(error, response) {
      if (error) {
        reject(error);
      } else {
        resolve(response);
